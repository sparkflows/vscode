...
def import_workflow(token: str, fire_host: str, file_path: str, proj_id: str, uuid_option: str):
    ...
    path = f"api/v1/workflows/import?projectId={proj_id}&uuidOption={uuid_option}"
    import_wf_api_url = urljoin(base, path)
    ...
    if import_wf_api_call_response.status_code == 200:
        response_data = import_wf_api_call_response.json()
        workflow_id = response_data[0]["id"]
