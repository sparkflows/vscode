...
from [workflow-nodes-catalogs](./workflow-nodes-catalogs/). Most workflows need 2–4 categories.

---

## 01 · Data Connectors `workflow-nodes-catalogs/data-connectors.md`
...
## 02 · Data Profiling `workflow-nodes-catalogs/data-profiling.md`
...
## 03 · Data Preparation `workflow-nodes-catalogs/data-preparation.md`
...
## 04 · Data Validation `workflow-nodes-catalogs/data-validation.md`
...
## 09 · Utilities `workflow-nodes-catalogs/utilities.md`
...
## 11 · Custom Processors `workflow-nodes-catalogs/custom-processors.md`
PySpark custom script nodes. Use when no standard node covers the required logic.

## 13 · Generative AI `workflow-nodes-catalogs/generative-ai.md`
